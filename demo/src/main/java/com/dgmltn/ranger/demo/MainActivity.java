...
public class MainActivityOriginal extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //vLeftIndex = (EditText) findViewById(R.id.leftIndex);
        //vRightIndex = (EditText) findViewById(R.id.rightIndex);
        //vRangeBar = (AbsRangeBar) findViewById(R.id.rangebar1);
        ...
        /*
        Button enableRange = (Button) findViewById(R.id.enableRange);
        enableRange.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                buttonEnableRange(v);
            }
        ...
        Button buttonSetByIndex = (Button) findViewById(R.id.buttonSetByIndex);
        buttonSetByIndex.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                buttonSetByIndex(v);
            }
        ...
        Button buttonUseIntLabels = (Button) findViewById(R.id.buttonUseIntLabels);
        buttonUseIntLabels.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                buttonUseIntLabels(v);
            }
        });

        Button buttonUseFloatLabels = (Button) findViewById(R.id.buttonUseFloatLabels);
        buttonUseFloatLabels.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                buttonUseFloatLabels(v);
            }
        });

        Button buttonUseCharLabels = (Button) findViewById(R.id.buttonUseCharLabels);
        buttonUseCharLabels.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                buttonUseCharLabels(v);
            }
        });
        */
    }
